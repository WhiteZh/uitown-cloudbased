    ...
    <>
      <div className="mx-auto mt-32 max-w-screen-2xl px-5 flex flex-row text-white">
        ...
        <div className="text-center xl:max-w-[48rem] xl:text-left px-10 py-12">
          <h5 className="font-thin tracking-widest text-sm">HI I'M UI-TOWN</h5>
          <h1 className="font-thin text-7xl text-[#D0C3F1] mt-16">
            A town of UI which brings your design to life.
          </h1>
          <h4 className={`tracking-widest leading-9 text-lg xl:max-w-lg ps-1.5 ${coolJazzFont.className} mt-16`}>
